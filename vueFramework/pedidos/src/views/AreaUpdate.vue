        ...
        <div class="card">
            <div class="card-content">
                <form @submit.prevent="update()">
                    ...
                    <p>Nombre del encargado: <input type="text" v-model="payload.encargado" required/></p>
                    <p>Numero de funcionarios: <input type="text" v-model="payload.funcionarios" required/></p>
                    <p>
                        <label>
